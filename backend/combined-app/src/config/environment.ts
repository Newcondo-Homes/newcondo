...
const envSchema = z.object({
  ...
  ENABLE_SMS_VERIFICATION: z.string().transform(val => val === 'true').default('true'),
  ENABLE_PROPERTY_BOUNDARIES: z.string().transform(val => val === 'true').default('true'),
  ENABLE_DUPLICATE_DETECTION: z.string().transform(val => val === 'true').default('true'),
  ENABLE_MARKING_SERVICE: z.string().transform(val => val === 'true').default('true'),
  ENABLE_VIRTUAL_ACCOUNTS: z.string().transform(val => val === 'true').default('true'),
