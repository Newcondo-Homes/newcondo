 ...
 */
export function formatPieChartData(data: Array<{ label: string; value: number }>) {
  return {
    labels: data.map(d => d.label),
    datasets: [
      {
 ...
 */
export function formatMultiLineChartData(
  datasets: Array<{
    label: string;
    data: Array<{ date: string; value: number }>;
    color?: string;
 ...
 */
export function formatStackedBarChartData(
  categories: string[],
  datasets: Array<{
    label: string;
    data: number[];
 ...
 */
export function formatScatterPlotData(
