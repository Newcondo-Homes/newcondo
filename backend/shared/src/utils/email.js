...
exports.getEmailStatus = exports.isValidEmail = exports.generateOTPEmailText = exports.generateOTPEmailHTML = exports.sendVerificationEmail = exports.sendTemplatedEmail = exports.sendBulkEmail = exports.sendAccountUnlockedEmail = exports.sendAccountLockedEmail = exports.sendPasswordChangeConfirmation = exports.sendPasswordResetEmail = exports.sendWelcomeEmail = exports.sendEmail = void 0;
...
const sendBulkEmail = async (templates) => {
    try {
        const promises = templates.map((template) => (0, exports.sendEmail)(template));
...
const generateVerificationEmailHTML = (otpCode, name) => {
...
const generateOTPEmailText = (otp, type, expire) => {
    const purpose = type === "EMAIL_VERIFICATION"
        ? "verify your account"
        : type === "LOGIN"
            ? "complete your login"
...
const generatePasswordChangeConfirmationHTML = (name) => {
    return `
    <!DOCTYPE html>
    <html>
    <head>
