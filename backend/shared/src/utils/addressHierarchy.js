...
exports.getLGAByCode = getLGAByCode;
exports.getLocationByCode = getLocationByCode;
exports.buildHierarchicalAddress = buildHierarchicalAddress;
exports.formatAddress = formatAddress;
exports.getAllStates = getAllStates;
exports.getLGAsForState = getLGAsForState;
exports.getLocationsForLGA = getLocationsForLGA;
exports.getAreasForLocation = getAreasForLocation;
exports.validateAddressHierarchy = validateAddressHierarchy;
exports.searchLocationsUtil = searchLocationsUtil;
/**
 ...
 */
function getLGAByCode(stateCode, lgaCode) {
 ...
 */
function getLocationByCode(stateCode, lgaCode, locationCode) {
 ...
 */
function buildHierarchicalAddress(stateCode, lgaCode, locationCode, area, streetAddress, landmark) {
    const state = getStateByCode(stateCode);
    const lga = getLGAByCode(stateCode, lgaCode);
 ...
 */
function getLGAsForState(stateCode) {
    const state = getStateByCode(stateCode);
    if (!state)
        return [];
 ...
 */
function getLocationsForLGA(stateCode, lgaCode) {
    const lga = getLGAByCode(stateCode, lgaCode);
    if (!lga)
        return [];
 ...
 */
function getAreasForLocation(stateCode, lgaCode, locationCode) {
    const location = getLocationByCode(stateCode, lgaCode, locationCode);
 ...
 */
function validateAddressHierarchy(stateCode, lgaCode, locationCode) {
    const state = getStateByCode(stateCode);
    if (!state) {
 ...
 */
function searchLocationsUtil(query) {
    const results = [];
...
//# sourceMappingURL=addressHierarchy.js.map