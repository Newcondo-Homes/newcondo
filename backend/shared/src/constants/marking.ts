...
export const URGENCY_PRIORITY_SCORES = {
  [URGENCY_LEVELS.URGENT]: 1000,
  [URGENCY_LEVELS.HIGH]: 500,
  [URGENCY_LEVELS.NORMAL]: 100,
...
export const VALIDATION_MESSAGES = {
  ...
  INSUFFICIENT_IMAGES: `At least ${IMAGE_REQUIREMENTS.MIN_COMPLETION_IMAGES} completion images required`,
  MISSING_BOUNDARY_DATA: 'Boundary data is required',
  INVALID_BOUNDARY_COORDINATES: 'Invalid boundary coordinates',
  INSUFFICIENT_COORDINATES: `At least ${BOUNDARY_REQUIREMENTS.MIN_COORDINATES} coordinates required`,
...
// Confirmation Cycles
export const CONFIRMATION_CYCLES = {
  ...
  CYCLE_PAYMENT: PARTIAL_PAYMENT.INCREMENT_AMOUNT, // Payment per cycle
} as const;
...
// Admin Constants
export const ADMIN = {
  NEWCONDO_ADMIN_COMMISSION: MARKING_FEES.NEWCONDO, // 25,000 for Newcondo to mark
