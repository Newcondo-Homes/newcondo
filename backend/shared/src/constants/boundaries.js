...
exports.NIGERIA_SPECIFIC = exports.PROPERTY_CATEGORIES = exports.BOUNDARY_OPACITY = exports.BOUNDARY_COLORS = exports.BOUNDARY_SUCCESS = exports.BOUNDARY_ERRORS = exports.FINGERPRINTING = exports.REMOTE_MARKING = exports.SESSION_LIMITS = exports.PROPERTY_TYPE_CONFIGS = exports.VALIDATION_THRESHOLDS = exports.ZOOM_LEVELS = exports.GPS_ACCURACY_REQUIREMENTS = exports.BOUNDARY_SIZE_LIMITS = void 0;
// Property boundary size limits (in square meters)
exports.BOUNDARY_SIZE_LIMITS = {
...
exports.GPS_ACCURACY_REQUIREMENTS = {
...
exports.PROPERTY_TYPE_CONFIGS = {
    ROOM: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_ROOM_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_ROOM_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.GOOD,
        allowedIn: ['apartment', 'house', 'duplex'], // Can be part of larger properties
    },
    APARTMENT: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_APARTMENT_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_APARTMENT_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.GOOD,
        allowedIn: ['building', 'complex'],
    },
    HOUSE: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_HOUSE_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_HOUSE_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.EXCELLENT,
        allowedIn: ['residential_area'],
    },
    DUPLEX: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_DUPLEX_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_DUPLEX_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.EXCELLENT,
        allowedIn: ['residential_area'],
    },
    OFFICE: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_OFFICE_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_OFFICE_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.GOOD,
        allowedIn: ['commercial_building', 'office_complex'],
    },
    SHOP: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_SHOP_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_SHOP_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.GOOD,
        allowedIn: ['commercial_area', 'market', 'plaza'],
    },
    WAREHOUSE: {
        minSize: exports.BOUNDARY_SIZE_LIMITS.MIN_WAREHOUSE_SIZE,
        maxSize: exports.BOUNDARY_SIZE_LIMITS.MAX_WAREHOUSE_SIZE,
        recommendedAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.ACCEPTABLE,
...
exports.PROPERTY_CATEGORIES = {
    RESIDENTIAL: {
        ...
        defaultAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.GOOD,
    ...
    INDUSTRIAL: {
        types: ['WAREHOUSE'],
        defaultAccuracy: exports.GPS_ACCURACY_REQUIREMENTS.ACCEPTABLE,
        allowsSubdivision: false,
    },
};
// Nigerian-specific location constants
exports.NIGERIA_SPECIFIC = {
