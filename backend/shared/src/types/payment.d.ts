...
export declare class FlutterwaveError extends Error {
    error: boolean;
    code?: string;
    data?: any;
    constructor(payload: {
...
export type PaymentEvent = 'payment.initiated' | 'payment.pending' | 'payment.success' | 'payment.failed' | 'payment.cancelled' | 'payment.refunded' | 'lock.acquired' | 'lock.released' | 'lock.expired' | 'receipt.generated' | 'retry.scheduled' | 'retry.exhausted';
