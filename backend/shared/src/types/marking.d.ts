...
export declare enum MarkingOption {
...
export declare const MARKING_FEES_TYPE: {
    readonly PROPERTY_OWNER_FEE: 20000;
    readonly NEWCONDO_ADMIN_FEE: 25000;
    readonly AGENT_COMMISSION_PERCENTAGE: 0.25;
    readonly INITIAL_PAYMENT_PERCENTAGE: 0.05;
...
export declare enum MarkingNotificationType {
...
export type CreateMarkingJobInput = Omit<MarkingJobRequest, 'shareableLink'> & {
    userId: string;
};
